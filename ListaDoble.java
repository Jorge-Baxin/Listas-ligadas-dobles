public class ListaDoble{
    ...
    public void insertarAntesUltimoNodo(String nombre) {
        ...
        if (topBackward != null) {
            ...
            // La lista está vacía, inserta como primer nodo
            insertaPrimerNodo(nombre);
        }
    }

    public void intercambiarNodos(String nodoBuscado, String nuevoNombre) {
        Node nodoActual = topForward;

        while (nodoActual != null && !nodoActual.name.equals(nodoBuscado)) {
            nodoActual = nodoActual.next;
        }

        if (nodoActual != null) {
            nodoActual.name = nuevoNombre;
        }
    }
